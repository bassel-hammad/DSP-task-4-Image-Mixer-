...
class ImageViewer:
    ...
    def regionsliceinner(self,value,mode):
        ...
        print(start_x, start_y, rectanglewidth, rectangleheight)
        ...
        outerdimensions = self.imaginary_part.shape
        ...
        sliceing_array[start_r:start_r+dimensions[0], start_c:start_c+dimensions[1]] = cropped
        sliceing_array[sliceing_array>=1]=1
        if mode==1:
    ...
    def regionsliceouter(self,value,mode):
        ...
        sliced[sliced>=1] = 1
        if mode==1:
            self.components["Magnitude"] = self.orgcomponents["Magnitude"].copy()*sliced
